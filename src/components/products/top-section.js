...
<div className="w-full flex flex-col xl:pl-40 xl:pr-16 xl:pt-10 px-8">
                     ...
                     <Button to="https://go.finout.io/start-now" className="mt-4 p-2 px-4 mr-4 rounded text-sm normal-case inline-flex text-center">
                     ...
                     <Button to={heroButton2Link} className="mt-4 p-2 px-4 rounded text-sm normal-case inline-flex text-center">
