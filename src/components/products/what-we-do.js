...
const { WhatWedoImg } = useStaticQuery(
  graphql`
  query {
    WhatWedoImg: file(relativePath: {eq: "fac.png"}) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, quality: 100, width: 737)
      }
    }
  }
`
...
<Section className="group relative pt-24 pb-10 text-center">
   <Grid.Container xs className="text-center">
      <div className="w-full"
         ...
         <h2 className="font-bold text-40xl mb-10 2xl:mb-14">What we do</h2>
