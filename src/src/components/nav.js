    ...
    <nav className={navClass}>
      ...
      <div className="fixed bottom-12 w-full mt-6 ml-auto text-center px-4 space-y-4 lg:static lg:w-auto lg:mt-0 lg:ml-5 lg:px-0 lg:space-y-0 lg:space-x-4">
        <Button
          ...
          className={isSticky ? "login btn btn-coral text-dark" : "login btn btn-coral btn-lg text-lg lg:btn-outlined-green-dark lg:text-white lg:btn-sm border-0"}>
          Log in
        </Button>
        <Button
          to={site?.siteMetadata?.login}
          className={isSticky ? "btn btn-coral text-white" : "btn btn-coral btn-lg text-lg lg:btn-outlined-green-dark lg:bg-white lg:text-green lg:btn-sm border-0"}>
          Get Started
        </Button>
      </div>
    </nav>
